...
#Lab 5 datasets to write code for anti-join to filter out people who didnt attend the SQL Symphony concert
...
#Lab 4 Question 6 Modifiied for across()
...
#Lab 4 Question 5 Modified not true 

region_median_income <- ca_childcare |>
  group_by(region, study_year) |>
  summarise(across(c(mhi_2018, total_property_taxes, sales_and_use_taxes),
                   ~ median(.x, na.rm = TRUE),
                   .names = "median_{.col}"),
            .groups = "drop")
```
