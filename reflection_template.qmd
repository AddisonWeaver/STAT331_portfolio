...
who_hired <- person |>
  ...
  inner_join(facebook_event_checkin, join_by = (id = person_id)) |> #based on jeremy's testimony, searched for the hirer.
  filter(
    hair_color == "red",
    gender == "female",
    car_make == "Tesla",
...
#Lab 5 Finding Suspects modified to write code for anti-join to filter out people who aren't suspects
