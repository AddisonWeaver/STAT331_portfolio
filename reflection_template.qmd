...
I believe my grade to be at a B+ because I fit all of the criteria of B, and have exemplified that in the portfolio, and have done a few extra things toward the A category but haven't hit many of the major things of A section. In the B category, I have believe I have hit the criteria for learning targets of B and lower but could use more creativity like DVS-3 and DVS 7 as well as work on Pe-1 and PE-3 at the midterm point. In revising thinking, I believe that I am toward the A category of submitting all assignments with revisions and reflections, but the reflections could be better and hit more bigger picture ideas than they already do by being more specific in future assignments from now on. In the extending thinking, I think I exceed expectations to the A category as well as for the collaborative criteria. When it comes to the peer review, like that of the reflections, I always submit code review but they could be more specific and constructive then they already are. In my example I talked about below, I struggled with providing criticism cause I didn't want to seem "mean" but really just trying to be helpful. I think those are a few ways I could improve, but I do want some feedback on if my code in the learning targets do demonstrate the quality of proficiency I believe I have achieved in the last few weeks of learning R. 
